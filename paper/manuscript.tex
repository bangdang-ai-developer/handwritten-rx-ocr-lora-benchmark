...
purpose-built GOT-OCR2.0 (roughly 580M parameters), as Figure~\ref{fig:cer_comparison} shows alongside the
...
Kaggle-Rx by both r = 8 and r = 32 (both
...
top-1 accuracy from 79.5\% to 92.4\% (Table~\ref{tab:headline}). This 558M-parameter fine-tuned model beats every zero-shot system we
...
broad, systematic shift rather than a handful of outlier failures. Figure~\ref{fig:domain_gap} plots the
...
signature of the specialization it has undergone. One thing worth clarifying so Table~2 is not misread
