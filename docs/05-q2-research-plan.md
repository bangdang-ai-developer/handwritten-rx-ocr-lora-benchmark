...
| Cost | APC $2,155 (verified live 2026-09-21; earlier notes in this document said $1,395, which was wrong/outdated — see the correction below) — a cheaper $755 one-time "Lifetime Membership" route exists for individual authors without institutional funding, important since this is independent research paid for out of pocket |
...
| 5 | **APC cost exceeds the personal budget** (this is independent research with no CCI funding, per the original stance) | Prioritize submitting to PeerJ CS first (APC $2,155, or $755 via the one-time "Lifetime Membership" route — see the correction above); if it's still an issue, switch entirely to Health Information Science and Systems (free subscription route) |
...
- Q2 (majority of sources). APC $2,155 (verified live 2026-09-21 directly on peerj.com/pricing — an earlier note here said $1,395, which was wrong); a $755 one-time "Lifetime Membership" route (1 paper/year, no institutional affiliation required) is cheaper than paying the standalone APC for a single article.
